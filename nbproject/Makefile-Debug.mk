...
${OBJECTDIR}/arqEscrita.o: arqEscrita.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arqEscrita.o arqEscrita.cpp

${OBJECTDIR}/arqEscrita2.o: arqEscrita2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arqEscrita2.o arqEscrita2.cpp

${OBJECTDIR}/arqLeitura.o: arqLeitura.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arqLeitura.o arqLeitura.cpp
...
${OBJECTDIR}/leitorString.o: leitorString.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/leitorString.o leitorString.cpp

${OBJECTDIR}/listaAdj.o: listaAdj.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaAdj.o listaAdj.cpp
...
${OBJECTDIR}/matrizAdj.o: matrizAdj.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/matrizAdj.o matrizAdj.cpp
